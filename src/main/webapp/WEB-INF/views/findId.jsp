    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            ...
            <div class="mb-3" <%--style="margin-left:120px;"--%>>
                ...
                <input id="inputUsername" class="form-control" type="text" name="username" style="margin: 0 auto; width: 80%;" placeholder="이름"/>
            </div>
            <br>
            <div class="mb-3" <%--style="margin-left:120px;"--%>>
            ...
            <div class="mb-3"  style="text-align: center;"  <%--style="margin-left:120px;"--%>>
                <button id="findId" class="btn btn-dark" style="/*width: 412.8px; height: 39px;*/ margin: 0 auto; font-family: 'Jeju Gothic', sans-serif; width: 80%;" type="button">아이디 확인</button>
            </div>
